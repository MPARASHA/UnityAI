...
public class SprintStateCustom : State
{
    //Set name of this state
    public SprintStateCustom():base("Sprint-Custom"){ }
    ...
    public override void ExitState(FSMAgent agent){ agent.SetSpeedModifierNormal(); }
}
